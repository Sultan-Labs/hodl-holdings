...
import { ShoppingBag, ArrowRight, Zap, Gem } from "lucide-react";

export default function ShopPage() {
  return (
    <div className="space-y-12" data-testid="page-shop">
      <section className="text-center relative py-24 px-6 glass-card rounded-[48px] overflow-hidden group border-white/5" data-testid="panel-shop-hero">
        <div
        ...
        <div className="relative z-10">
          <motion.div 
            ...
            data-testid="pill-shop"
          >
            <span className="text-[11px] font-bold tracking-[0.2em] uppercase text-[hsl(var(--ring))]">Exclusive Gear</span>
          ...
          >
            Digital <span className="bg-gradient-to-r from-[#55FFAC] to-[#2C8CFF] bg-clip-text text-transparent">Collectibles</span> & Apparel.
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Premium gear and digital collectibles are on the way. Get ready for the exclusive Hodl Holdings drop, built for the decentralized community.
          </motion.p>

          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8" data-testid="grid-shop-previews">
            {[{
              title: "Genesis Apparel",
              desc: "High-quality, limited edition streetwear for the Hodl community.",
              icon: ShoppingBag,
              id: "apparel",
              accent: "rgba(85,255,172,0.15)"
            }, {
              title: "Ecosystem NFTs",
              desc: "Digital collectibles that unlock exclusive platform benefits.",
              icon: Gem,
              id: "nfts",
              accent: "rgba(0,214,255,0.15)"
            }, {
              title: "Early Access",
              desc: "Presale participants get priority access to all drops.",
              icon: Zap,
              id: "early",
              accent: "rgba(85,255,172,0.15)"
            }].map((p, idx) => (
              <motion.div 
                ...
                data-testid={`card-shop-preview-${p.id}`}
              >
                <div
